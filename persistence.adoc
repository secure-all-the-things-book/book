...
While the Spring Authorization Server does amazing things out of the box, its real power lay in all the knobs and leavers available to you because it's just another Spring Boot autoconfiguration and starter.
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/SecurityConfiguration.java[]
----
...
[source,sql]
----
include::{code}/authorization-server/authorization-server/src/main/resources/sql/schema/users.sql[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/UsersConfiguration.java[]
----
...
[source,sql]
----
include::{code}/authorization-server/authorization-server/src/main/resources/sql/schema/oauth2-registered-client.sql[]
----
...
[source,sql]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/ClientsConfiguration.java[]
----
...
[source,sql]
----
include::{code}/authorization-server/authorization-server/src/main/resources/sql/schema/oauth2-authorization-schema.sql[]
----
...
[source,sql]
----
include::{code}/authorization-server/authorization-server/src/main/resources/sql/schema/oauth2-authorization-consent-schema.sql[]
----
...
Add the following dependency to the build: `org.springframework.session`:`spring-session-jdbc`
...
[source,sql]
----
include::{code}/authorization-server/authorization-server/src/main/resources/sql/schema/spring-session-jdbc.sql[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/snippets/SimpleKeyConfiguration.java[]
----
...
Remember what we said about the keys in the last section?
How should we encrypt the keys, rather than having them laying around on disk?
...
If you're using the `compose.yml` file, then you can run:
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/Keys.java[]
----
...
It's a record to hold both the generated public and private keys.

[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/RsaKeyPair.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/RsaKeyPairRepository.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/RsaPrivateKeyConverter.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/RsaPublicKeyConverter.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/Converters.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/JdbcRsaKeyPairRepository.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/RsaKeyPairRowMapper.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/RsaKeyPairRepositoryJWKSource.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/KeyConfiguration.java[]
----
...
[source,java]
----
include::{code}/authorization-server/authorization-server/src/main/java/com/example/authorization_server/keys/LifecycleConfiguration.java[]
----
