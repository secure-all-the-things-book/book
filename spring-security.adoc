...
Indeed, most of the really good implementations come from these libraries and require their presence on the CLASSPATH.

You could use these algorithms directly if you wanted.

----
var bcrypt = new BCryptPasswordEncoder();
----

I always prefer to use the one that comes from `PasswordEncoderFactories`, which is a composite  `PasswordEncoder`.
...
So the `DelegatingPasswordEncoder` prefixes all passwords with the name of the algorithm used to encode it.
