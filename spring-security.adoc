...
Consult the console, and you'll see a link. Copy and paste it into the browser, and you should see your username.

Easy! My friend James Ward took this exact same approach and did something super interesting, straddling
