...
Return to the database tables and you should see data in those SQL tables.
You can restart the Spring Security application and attempt to login again with a Passkey and this time, it'll work just fine.
