...
Let's turn our attention to how we make more granular decisions about what is required of an authenticated user for particular aspects of the application.
