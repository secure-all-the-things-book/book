...
Now that you know, conceptually, about how to _do authentication_, you'll hopefully appreciate that the hardest part about security is just getting your code in the right place to do authentication in the first place.
...
We're going to connect this application to a SQL database. Here's our initial `application.properties` configuration.
