...
As of this writing, the latest Long Term Support (LTS) release is Java {java-lts-version}. There are new releases of Java coming out every six months. By the time you read this, we could easily be on many versions beyond that.
