...
This book was written with Java 25 in mind, but you should be using whatever the latest-and-greatest version of Java available to you is.
...
But no more.
With Java 25, it's trivial to define small ad-hoc objects and to vary behavior based on those objects.
...
And just like that, without us ever realizing it, Java 25 manages to introduce support for a completely new style of programming: data oriented programming.
