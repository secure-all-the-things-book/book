...
In most cases, the user would simply add the relevatn annotation from one of the dozens of supported test modules (`@JsonTest`, `@DataJdbcTest`, `@WebMvcTest`, etc.) to get the requisite autoconfiguration for just that subsystem.
