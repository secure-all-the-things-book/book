...
[source,java]
----
include::{code}/beans-to-boot/beans-to-boot/src/test/java/com/example/beans_to_boot/boot/SimpleController.java[]
----
...
[source,java]
----
include::{code}/beans-to-boot/beans-to-boot/src/test/java/com/example/beans_to_boot/boot/SimpleControllerTest.java[]
----
...
[source,java]
----
include::{code}/beans-to-boot/beans-to-boot/src/test/java/com/example/beans_to_boot/boot/SimpleClientTest.java[]
----

Here, we're using a fake client to exercise the network and protocol interface for the service and to make assertsion about the results.
